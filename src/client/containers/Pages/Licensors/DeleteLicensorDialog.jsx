...
export default function DeleteLicensorDialog(props) {

  const handleSubmit = async (event) => {
    event.preventDefault();

    const response = await privateFetcher('/api/private/licensors/delete', {id: props.licensorId});
      ...
      <form onSubmit={handleSubmit} >
        ...
        <DialogContent dividers>
          <Typography gutterBottom>
            Точно решили удалить Лицензиара c ID {props.licensorId}?
          </Typography>
        </DialogContent>
        <DialogActions>
